...
txt_hello = 'Здравствуй и добро пожаловать в программу по определению состояния здоровья!'
txt_next = 'Начать'
txt_instruction = ('Данное приложение позволит вам с помощью теста Руфье провести первичную диагностику вашего здоровья.\n'
                   ...
                   'ушах, сильная одышка и др.), то тест необходимо остановить и обратиться к врачу.' )
txt_title = 'Здоровье'
